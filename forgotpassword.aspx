				...
				<div class="module form-module">
				  ...
				  <div class="form">
                    ...
                    <asp:Label ID="lblpassword" runat="server" Text="Label" Visible=false></asp:Label>
					 <asp:TextBox ID="Txtforpass" runat="server" placeholder="Email" MaxLength="30"></asp:TextBox>
                    <asp:Button ID="Button1" runat="server" Text="Send" onclick="Button1_Click1" />
					</form>
				  </div>
				  
				  <div class="cta"><a href="login.aspx">Sign In</a>&nbsp;& &nbsp;<a href="Registration.aspx">Sign Up</a></div>
				</div>
			</div>
			<script>

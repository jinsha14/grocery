...
<!-- mail -->
		<div class="mail">
            ...
            <div>
                <table style="width: 109%; height: 56px; font-family: 'Times New Roman', Times, serif; font-size: medium;">
                    <tr>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style3">
                            <asp:Button ID="txtsubmit" runat="server" Text="Search" Height="34px" 
                                Width="181px" BackColor="#84C639" onclick="txtsubmit_Click"/>
                            </td>
                        <td class="style3">
                        </td>
                    </tr>
             ...
             CellPadding="4" ForeColor="#333333" 
                    GridLines="None" Width="689px" AutoGenerateColumns="False">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                      <asp:BoundField HeaderText = "SLNo" DataField="product_id"/>
                        <asp:BoundField HeaderText = "ProductName" DataField="product_name"/>
                          <asp:BoundField HeaderText = "Price" DataField="product_finalprice"/>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" Height="100px" Width="100px" ImageUrl='<%# "pdcHandler.ashx?ImID="+ Eval("product_id")  %>'/> 
                            </ItemTemplate>
                        </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewards.aspx.cs" Inherits="Admin_rewards" %>
            ...
            <div>
                <table style="width: 109%; height: 211px; font-family: 'Times New Roman', Times, serif; font-size: medium;">
                    ...
                    <tr>
                        ...
                        <td class="style5">
                            <asp:TextBox ID="Txtrwnm" runat="server" Height="34px" Width="278px" 
                                Placeholder="Reward Name" MaxLength = "30" ></asp:TextBox>
                            &nbsp;
                        </td>
                        <td class="style3">
                            </td>
                    ...
                    <tr>
                        ...
                        <td class="style5">
                            <asp:TextBox ID="txtpoints" runat="server" Height="34px" Width="278px" 
                                placeholder="Points" MaxLength = "5"></asp:TextBox>
                        </td>
                        <td class="style3">
                            </td>
                        <td class="style3">
                    ...
                    <tr>
                        ...
                        <td class="style14">
                            <asp:TextBox ID="txtgift" runat="server" Height="34px" Width="278px" 
                                placeholder="Gift" MaxLength = "25"></asp:TextBox>
                        </td>
                        <td class="style12">
                            </td>
                        <td class="style12">
                    ...
                    <tr>
                        ...
                        <td class="style11">
                            <asp:Button ID="Button2" runat="server" Text="Submit" Height="34px" 

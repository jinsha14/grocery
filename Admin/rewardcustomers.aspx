<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewardcustomers.aspx.cs" Inherits="Admin_rewardcustomers" %>
...
<!-- mail -->
		<div class="mail">
			<h3>Reward win Customer&#39;s Details</h3>
            <div>
                    ...
                    <tr>
                        ...
                        <td class="style1">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" OnPageIndexChanging="OnPageIndexChanging" 
                                GridLines="None" Width="824px" Height="132px" >

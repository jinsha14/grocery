<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewardsmaintenance.aspx.cs" Inherits="Admin_rewardsmaintenance" %>
                    ...
                    <tr>
                        ...
                        <td class="style5">
                            <asp:GridView ID="GridView1" 
                                            runat="server" DataKeyNames="reward_id" 
            OnRowDeleting ="OnRowDeleting" OnRowEditing ="OnRowEditing" 
            OnRowUpdating ="OnRowUpdating" 
            OnRowCancelingEdit="OnRowCancelingEdit" OnPageIndexChanging="OnPageIndexChanging"  
                        CellPadding="4" ForeColor="#333333" 
                    GridLines="None" Width="792px" AutoGenerateColumns="False" Height="124px">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                      <asp:BoundField HeaderText = "RewardId" DataField="reward_id"/>
                    <asp:BoundField HeaderText = "Name" DataField="reward_name"/>
                <asp:BoundField HeaderText = "Points" DataField="reward_point"/>
                <asp:BoundField HeaderText = "Gift" DataField="reward_gift"/>
                <asp:BoundField HeaderText = "Date" DataField="reward_date"/>

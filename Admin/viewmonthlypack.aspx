<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewmonthlypack.aspx.cs" Inherits="Admin_viewmonthlypack" %>
            ...
            <div>
                <table style="width: 109%; height: 211px; font-family: 'Times New Roman', Times, serif; font-size: medium;">
                    ...
                    <tr>
                        <td colspan="5">
                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            &nbsp;&nbsp;<asp:DropDownList ID="drpcustid" runat="server" Height="30px" 
                                Width="235px" ForeColor="Black">
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem></asp:ListItem>
                            </asp:DropDownList>
&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button1" runat="server" BackColor="#84C639" Text="View" 
                    ...
                    <tr>
                        ...
                        <td class="style4">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" OnPageIndexChanging="OnPageIndexChanging" 
                                GridLines="None" Width="779px" Height="143px" >

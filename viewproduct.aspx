<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewproduct.aspx.cs" Inherits="_Default" %>
                    ...
                    <tr>
                        ...
                        <td class="style3">
                            <asp:Button ID="txtsubmit" runat="server" Text="Upload" Height="34px" 
                                Width="181px" BackColor="#84C639" onclick="Button2_Click"/>
                            </td>
                        <td class="style3">
                        </td>
                    </tr>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" 
                                    CommandName="Select" onclick="LinkButton1_Click" Text="Add to Cart"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="false" 
                                    CommandName="Select" onclick="LinkButton2_Click" Text="Add to Monthly Pack"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>

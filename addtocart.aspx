                    ...
                    <tr>
                        ...
                        <td class="style4" colspan="2" style="border: thin solid #C0C0C0">
                            <asp:Button ID="Button2" runat="server" 
                                Text="Add to Cart" Height="34px" 
                                Width="130px" BackColor="#84C639" onclick="Button2_Click" />
                        &nbsp;<asp:Button ID="Button3" runat="server" 
                                Text="Continue" Height="34px" 
                                Width="130px" BackColor="#84C639" onclick="Button3_Click"  />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="style1">
                            &nbsp;</td>
                        <td class="style1">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Visible="False" ForeColor="Lime"></asp:Label>
                        &nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="discount" runat="server" OnClick="discount_Click">Apply Now</asp:LinkButton>
                        </td>
                        <td class="style6">
                            &nbsp;</td>
                        <td class="style3">
			...
			<div class="agile_footer_grids">
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						<h4>100% secure payments>
						 src="Template/images/card.png" alt=" " class="img-responsive" />
					v>
				</div>

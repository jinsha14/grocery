...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="Template/css/flexslider.css" type="text/css" media="screen" property="" />
...
<!-- banner -->
	<div class="banner_bottom">
			...
			<div class="wthree_banner_bottom_left_grid_sub1">
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="Template/images/6.jpg" alt=" " class="img-responsive" />
						<div class="wthree_banner_btm_pos1">
							<h3>Save <span>Upto</span> Rs.10</h3>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
								...
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="Template/images/1.png" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="Template/images/3.png" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="Template/images/2.png" alt=" " class="img-responsive" /></a>
											<p>Pepsi soft drink (2 Ltr)</p>
											<h4>Rs.8.00 <span>Rs.10.00</span></h4>
										</div>
										<div class="snipcart-details top_brand_home_details">
											<form action="#" method="post">
												<fieldset>
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="Template/images/4.png" alt=" " class="img-responsive" /></a>
											<p>dogs food (4 Kg)</p>
											<h4>Rs.9.00 <span>Rs.11.00</span></h4>
										</div>
										<div class="snipcart-details top_brand_home_details">
											<form action="#" method="post">
												<fieldset>
				...
				<div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
					<div class="w3l_fresh_vegetables_grid2">
						<ul>
							...
							<li><i class="fa fa-check" aria-hidden="true"></i><a href="#l">Bread & Bakery</a></li>
				...
				<div class="col-md-9 w3l_fresh_vegetables_grid_right">
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<img src="Template/images/8.jpg" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<div class="w3l_fresh_vegetables_grid1_rel">
								<img src="Template/images/7.jpg" alt=" " class="img-responsive" />
						...
						<div class="w3l_fresh_vegetables_grid1_bottom">
							<img src="Template/images/10.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<img src="Template/images/9.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="w3l_fresh_vegetables_grid1_bottom">
							<img src="Template/images/11.jpg" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="clearfix"> </div>

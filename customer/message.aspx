<%@ Page Language="C#" AutoEventWireup="true" CodeFile="message.aspx.cs" Inherits="customer_message" %>
...
<!-- mail -->
		<div class="mail">
			<h3>Successfully Cart Completed!!!</h3>
            <div>
                <table style="width: 109%; height: 211px; font-family: 'Times New Roman', Times, serif; font-size: medium;">
                    ...
                    <tr>
                        ...
                        <td class="style1" colspan="2" 
                            style="font-family: 'Times New Roman', Times, serif; font-weight: bold; color: #FF0000">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            With in two days we will delivered your Products!!!!&nbsp;</td>
                        <td>
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td class="style4">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/Template/images/4.jpg" />
                            </td>
                        <td class="style5" style="text-align: justify">
                            D-Mart offers a wide range of products which range from apparels, food, farm products, furniture,child care, toys, etc of various brands like Levis, Allen Solly, Pepsi, Coca- Cola, HUL, ITC, P&G, LG, Samsung, Nokia, HP etc..</td>
                        <td class="style3">
                            </td>
                        <td class="style3">
                        </td>

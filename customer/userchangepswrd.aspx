<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userchangepswrd.aspx.cs" Inherits="customer_userchangepswrd" %>
            ...
            <div>
                <table style="width: 109%; height: 159px; font-family: 'Times New Roman', Times, serif; font-size: medium;">
                    ...
                    <tr>
                        ...
                        <td class="style5">
                            <asp:TextBox ID="Txtnwpsswrd" runat="server" Height="34px" Width="278px" 
                                Placeholder="New Password" MaxLength = "30" TextMode="Password" ></asp:TextBox>
                            &nbsp;
                        </td>
                        <td class="style3">
                            </td>
                    ...
                    <tr>
                        ...
                        <td class="style5">
                            <asp:TextBox ID="txtcnfrmpssd" runat="server" Height="34px" Width="278px" 
                                ...
                                ontextchanged="txtcnfrmpssd_TextChanged" TextMode="Password"></asp:TextBox>
                        </td>
                        <td class="style3">
                            </td>
                        <td class="style3">
                    ...
                    <tr>
                        ...
                        <td class="style14">
                            <asp:Button ID="Button2" runat="server" Text="Change" Height="34px" 

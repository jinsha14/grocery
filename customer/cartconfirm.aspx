<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cartconfirm.aspx.cs" Inherits="customer_cartconfirm" %>
		...
		<div class="mail">
            ...
            <div>
                <table style="width: 109%; height: 211px; font-family: 'Times New Roman', Times, serif; font-size: medium;">
                    ...
                    <tr>
                        <td class="style15" colspan="5" style="font-weight: bold">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Total No.of Items :
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        ...
                        <td class="style4">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="user_cart_id" 
            OnRowDeleting ="OnRowDeleting"  OnPageIndexChanging="OnPageIndexChanging"
                                GridLines="None" Width="704px" AutoGenerateColumns="False" >
                                <AlternatingRowStyle BackColor="White" />
                                <Columns >
                                 <asp:BoundField HeaderText = "CartId" DataField="user_cart_id"/>
                    <asp:BoundField HeaderText = "UserId" DataField="user_reg_id"/>
                <asp:BoundField HeaderText = "Id" DataField="product_id"/>
                ...
                <asp:BoundField HeaderText = "MRP" DataField="prouct_MRP"/>
                <asp:BoundField HeaderText = "TotalAmount" DataField="product_finalprice"/>
                    ...
                    <tr>
                        ...
                        <td class="style13">
                            ...
                            <asp:Button ID="Button3" runat="server" 
                                Text="Click to confirm cart" Height="34px" 
                                Width="218px" BackColor="#84C639" onclick="Button2_Click" 
                                Font-Bold="True" />
                            <asp:Label ID="lblrpoint" runat="server" Text="0"></asp:Label>
                        </td>
                        <td class="style14">
                            &nbsp;</td>
                        <td class="style12">
